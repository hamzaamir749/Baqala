...
import com.StackBuffers.baqala.Adapters.PendingTaskAdapter;
...
public class PendingVisitsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending_visits);
        context=this;

        mToolBar = findViewById(R.id.pendingvists_toolbar);

        setSupportActionBar(mToolBar);
        getSupportActionBar().setTitle("Pending Visits");
        ...
        recyclerView = findViewById(R.id.recycler_view_pending);
    ...
    private void getPendingData(int id) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://demonline.tech/app_admin/api/pending_tasks.php", new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (status.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String pStatus = jsonObject.getString("visit_status");
                            Double lat = jsonObject.getDouble("lat");
                            Double lng=jsonObject.getDouble("long");



                            PendingTaskModel model= new PendingTaskModel(lat,lng,name,city,pStatus);
                            list.add(model);

                        }
                        adapter = new PendingTaskAdapter(list, context.getApplicationContext());
