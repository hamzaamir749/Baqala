...
public class DesitinationNearbyActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desitination_nearby);
    ...
    private void ShowDialouge() {
        final android.app.AlertDialog dialogBuilder = new android.app.AlertDialog.Builder(DesitinationNearbyActivity.this).create();
        ...
        startTask.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UserSessionManager userSessionManager=new UserSessionManager(DesitinationNearbyActivity.this);
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(
                DesitinationNearbyActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                (DesitinationNearbyActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(DesitinationNearbyActivity.this, new String[]
    ...
    private void submitToServer() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(DesitinationNearbyActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://demonline.tech/app_admin/api/task_cancellation.php",
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(DesitinationNearbyActivity.this, "Server Response: " + error.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
        ...
        Volley.newRequestQueue(DesitinationNearbyActivity.this).add(stringRequest);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(tasklats, taskLongs);
