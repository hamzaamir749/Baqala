...
public class OutofStock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewstock = findViewById(R.id.btn_outofstock_view);
        context=this;


        mToolBar = findViewById(R.id.outofstock_Toolbar);
        ...
        viewstock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final View dialogView = inflater.inflate(R.layout.outofstock_expand, null);
